...
namespace ServiceRest_091_Elfandira
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data source=MSI;Initial catalog=\"TI_UMY\";Persist security Info=True;user ID=sa;Password=4dehidayat");
